...
const calendarSlotFns = calendarSlotNames.map(([slotName, slotKey]) => [slotName, createRecipe(slotKey, calendarDefaultVariants, getSlotCompoundVariant(calendarCompoundVariants, slotName))])
...
export const calendar = Object.assign(calendarFn, {
  __recipe__: false,
  raw: (props) => props,
